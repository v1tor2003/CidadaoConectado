...
public static class Seeder
{
    ...
    private static void SeedUsers(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>()
                    .HasData(
                        new User { Id = "1", Name = "User Name1", Email = "user1@example.com" },
                        new User { Id = "2", Name = "User Name2", Email = "user2@example.com" },
                        new User { Id = "3", Name = "User Name3", Email = "user3@example.com" }
                    );
    }
